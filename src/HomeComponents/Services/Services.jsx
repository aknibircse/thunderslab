...
const Services = () => {
  return (
    <div className=" max-w-[1800px] mx-auto xl:px-20 md:px-10 sm:px-2 px-4 my-20 mt-40">
      {/* headline */}
      <div>
        <h1 className="text-md font-semibold text-white">Our Services</h1>
          ...
          <SwiperSlide>
            ...
            <div className="ml-6">
              ...
              >
                ...
                >
                  <div className="m-6">
                    <h1 className="text-white text-3xl  my-10">Play Testing</h1>
                    ...
                    <p className="text-white mb-10">
                      Assess balance, pacing, and mechanics for an enjoyable and
                ...
                >
                  <div className="mx-6">
                    ...
                    <p className="text-white mb-10">
                      ...
                      decision-making. Ensuring challenging <br /> and strategic
                      AI opponents for players.
                    </p>
                    <p className="text-[#E63846] text-xl mb-5">
                    ...
                    <p className="text-white">
                      ...
                      management mechanics.  Balancing resource
                      availability and impact on gameplay.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                >
                  <div className="m-6">
                    ...
                    Testing core gameplay mechanics such <br /> as movement, physics, and controls. Ensuring smooth and responsive gameplay.
                    </p>
                    <p className="text-[#E63846] text-xl mb-5">
                    AI Competency Testing
                    </p>
                    <p className="text-white mb-10">
                    Assessing AI opponents skill levels and behaviors. Creating AI opponents with varying difficulty levels.
                    </p>
                    <p className="text-[#E63846] text-xl mb-5">
                    Multiplayer Testing
                    </p>
                    <p className="text-white">
                    Testing online multiplayer functionality for stability and performance. Addressing latency and synchronization issues.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <SwiperSlide>
            ...
            <div className="ml-6">          
              ...
              >
                ...
                >
                  <div className="m-6">
                    <h1 className="text-white text-3xl  my-10">FPS Testing</h1>
                    <p className="text-[#E63846] text-xl mb-5">
          ...
          <SwiperSlide>
            ...
            <div className="ml-6">
              ...
              >
                ...
                >
                  <div className="m-6">
                    <h1 className="text-white text-3xl  my-10">RPG Testing</h1>
                    <p className="text-[#E63846] text-xl mb-5">
          ...
          <SwiperSlide>
            ...
            <div className="ml-6">
              ...
              >
                ...
                >
                  <div className="m-6">
                    <h1 className="text-white text-3xl  my-10">Horror Game Testing</h1>
                    <p className="text-[#E63846] text-xl mb-5">
                      Atmosphere Testing:
                    </p>
                    <p className="text-white mb-10">
          ...
          <SwiperSlide>
            ...
            <div className="ml-6">
              ...
              >
                ...
                >
                  <div className="m-6">
                    <h1 className="text-white text-3xl  my-10">MMO Testing</h1>
                    <p className="text-[#E63846] text-xl mb-5">
                      World Testing
                    </p>
                    <p className="text-white mb-10">
          ...
          <SwiperSlide>
            ...
            <div className="ml-6">
              ...
              >
                ...
                >
                  <div className="m-6">
                    <h1 className="text-white text-3xl  my-10">Simulation Game Testing</h1>
                    <p className="text-[#E63846] text-xl mb-5">
                      Realism Testing
                    </p>
                    <p className="text-white mb-10">
