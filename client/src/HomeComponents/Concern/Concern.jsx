...
const Concern = () => {
  return (
    <div className=" my-36 ">
      <div className="max-w-[1800px] mx-auto xl:px-20 md:px-10 px-4 mt-40 flex justify-between items-center">
        <div>
